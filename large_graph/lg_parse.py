...
def parse_method(args, n, c, d, device):
    model = MPNNs(d, args.hidden_channels, c, local_layers=args.local_layers,
            ...
            post_bn=args.post_bn, local_attn=args.local_attn, res=args.res, dp=args.dp, ln=args.ln, add_=args.add, sage=args.sage).to(device)
    return model
...
def parser_add_main_args(parser):
    ...
    # model
    parser.add_argument('--method', type=str, default='gnn')
